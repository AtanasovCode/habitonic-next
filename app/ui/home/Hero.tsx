...
export default function Hero() {
    return (
        <div className="min-h-screen bg-background text-text flex items-start justify-center">
            <div className="min-h-screen max-w-[90vw] flex flex-col-reverse lg:flex-row items-center justify-end lg:justify-between gap-8">
                ...
                <div className="w-full h-[33dvh] lg:w-2/5 lg:h-[98dvh] rounded-md overflow-hidden">
                    <HeroImage />
                </div>
            </div>
        </div>
